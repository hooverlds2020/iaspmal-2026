...
const MainLayout = ({ lang, setLang }) => {
  ...
  const menuItems = [
    { 
      ...
      label_pt: 'Sobre o Congresso'
    },    { 
      id: 'conferenciantes', 
      label: 'Conferencias magistrales y conversatorios',
      label_pt: 'Conferências magistrais e conversatórios'
    },
    { 
      id: 'cuotas', 
      label: 'Cuotas de inscripción',
      label_pt: 'Taxas de inscrição'
    },
    { 
      id: 'comite-academico', 
      label: 'Comité Académico',
      label_pt: 'Comitê Acadêmico'
    },
    { 
      id: 'comite-organizador', 
      label: 'Comité Organizador',
      label_pt: 'Comitê Organizador'
    },
    { 
      id: 'programa', 
      label: 'Programa',
    ...
    { 
      ...
      label_pt: 'Apresentações de livros'
    },
    {
          ...
          <div className="space-y-6">
                ...
                <thead className="bg-teal-600 text-white">
                  <tr>
                    ...
                    <th className="p-3 text-center">
                      {lang === 'es' ? 'Pago antes del 31/05/26' : 'Pagamento antes de 31/05/26'}
                    </th>
                    <th className="p-3 text-center">
                      {lang === 'es' ? 'Después del 01/06/26' : 'Depois de 01/06/26'}
                    </th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-t bg-white hover:bg-gray-50">
                    <td className="p-3">
                      {lang === 'es' ? 'Investigador/a del sur global' : 'Pesquisador/a do sul global'}
                    </td>
                    <td className="p-3 text-center font-semibold">$800</td>
                    <td className="p-3 text-center font-semibold">$1,000</td>
                  </tr>
                  <tr className="border-t bg-white hover:bg-gray-50">
                    <td className="p-3">
                      {lang === 'es' ? 'Investigador/a del norte global' : 'Pesquisador/a do norte global'}
                    </td>
                    <td className="p-3 text-center font-semibold">$1,300</td>
                    <td className="p-3 text-center font-semibold">$1,500</td>
                  </tr>
                  <tr className="border-t bg-white hover:bg-gray-50">
                    <td className="p-3">
                      {lang === 'es' ? 'Investigador/a de institución convocante' : 'Pesquisador/a de instituição convocante'}
                    </td>
                    <td className="p-3 text-center font-semibold">$400</td>
                    <td className="p-3 text-center font-semibold">$600</td>
                  </tr>
                  <tr className="border-t bg-white hover:bg-gray-50">
                    <td className="p-3">
                      {lang === 'es' ? 'Estudiante' : 'Estudante'}
                    </td>
                    <td className="p-3 text-center font-semibold">$300</td>
                    <td className="p-3 text-center font-semibold">$500</td>
                  </tr>
                  <tr className="border-t bg-white hover:bg-gray-50">
                    <td className="p-3">
                      {lang === 'es' ? 'Asistente' : 'Assistente'}
                    </td>
                    <td className="p-3 text-center font-semibold">$200</td>
                    <td className="p-3 text-center font-semibold">$300</td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="flex justify-center">
              <button
                ...
                className="bg-teal-600 hover:bg-teal-700 text-white font-bold py-4 px-8 rounded-lg text-lg transition shadow-lg hover:shadow-xl"
              >
              ...
              <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
                <div className="bg-white rounded-xl max-w-3xl w-full my-8 relative">
                  <button
                    ...
                    className="absolute top-4 right-4 bg-gray-100 hover:bg-gray-200 rounded-full w-10 h-10 flex items-center justify-center font-bold text-gray-600 z-10"
                  >
                    ✕
                  </button>
                  <div className="p-6">
                    <RegistrationForm lang={lang} onSuccess={() => setShowRegistration(false)} />
                  </div>
                </div>
              </div>
            )}
