            ...
            {visibleSchedule.length > 0 ? visibleSchedule.map(ev => {
                ...
                <div className="p-4 flex-1 min-w-0 flex flex-col justify-center">
                    <div className="flex items-center gap-2 mb-1.5">
                        ...
                        <span className="bg-emerald-600 text-white text-[9px] font-black px-2 py-0.5 rounded-md uppercase tracking-wide">Presentacion de Publicaciones</span>
                        ) : ev.event_type === 'plenaria' ? (
                        <span className="bg-amber-600 text-white text-[9px] font-black px-2 py-0.5 rounded-md uppercase tracking-wide">Conferencia Plenaria</span>
                        ) : ev.event_type === 'conversatorio' ? (
                        <span className="bg-orange-600 text-white text-[9px] font-black px-2 py-0.5 rounded-md uppercase tracking-wide">Conversatorio</span>
                        ) : (ev.event_type === 'musica' || ev.event_type === 'concierto_estelar') ? (
                        <span className="bg-indigo-600 text-white text-[9px] font-black px-2 py-0.5 rounded-md uppercase tracking-wide">Concierto</span>
                        ) : ev.event_type === 'inauguracion' ? (
                        <span className="bg-indigo-600 text-white text-[9px] font-black px-2 py-0.5 rounded-md uppercase tracking-wide">Inauguracion</span>
                        ) : (
                    ...
                    {ev.event_type === 'plenaria' && ev.plenaria_ponentes && (
                      <p className="text-[10px] font-bold text-amber-600 uppercase mb-2 flex items-center gap-1">
                        <User size={10}/> Ponente(s): {ev.plenaria_ponentes}
                      </p>
                    )}
                    {ev.event_type === 'conversatorio' && ev.conversatorio_participantes && (
                      <p className="text-[10px] font-bold text-orange-600 uppercase mb-2 flex items-center gap-1">
                        <User size={10}/> Participan: {ev.conversatorio_participantes}
                      </p>
                    )}
