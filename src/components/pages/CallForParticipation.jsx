...
const CallForParticipation = ({ lang }) => {
  const content = {
    ...
    pt: {
      ...
      intro2: `O campo musical não pode ser pensado como autônomo dos conflitos e tensões sociais, como nos recordam polêmicas recentes como a gerada por "+57" na Colômbia ou os corridos tumbados no México. Neste encontro debateremos sobre as intersecções entre ética, política e música popular, assim como sobre os temas que serão tratados nos 18 simpósios que vertebram o Congresso.`,
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-8 shadow-sm animate-in fade-in duration-500">
